...
export const mockGames: Game[] = [
  // MLB GAME
  {
    ...
    scheduledTime: '🔴 LIVE (Bot 6th) • Started 7:05 PM EDT',
    startTimeUtc: '2026-09-15T23:05:00.000Z',
    gameDate: '2026-09-15',
    displayDate: 'Tue, Sep 15, 2026',
    displayTime: '7:05 PM EDT',
    timeZone: 'EDT',
    status: 'LIVE',
    ...
    liveInGamePrediction: {
      liveHomeWinProb: 0.764,
      liveAwayWinProb: 0.236,
      preGameHomeProb: 0.672,
      probabilityShiftDelta: 0.092,
      shiftDirection: 'HOME_SURGE',
      liveFairMoneylineHome: -324,
      liveFairMoneylineAway: +260,
      liveProjectedTotal: 7.8,
      liveProjectedSpread: -1.9,
      liveValueOpportunity: {
        betType: 'LIVE_IN_PLAY_MONEYLINE',
        marketLiveOdds: -230,
        modelLiveProb: 0.764,
        edgePct: 9.2,
        action: 'STRONG_LIVE_VALUE',
        reasoning: 'Yankees 3-1 lead with Cole holding Boston to 2 hits increases model win expectation from 67.2% to 76.4% (-324 fair vs -230 market).'
      },
      lastRecalculatedAt: '2026-09-15T23:45:00.000Z',
      inGamePace: 'Standard Run Pace (1.00 runs/inn)',
      leverageIndex: 2.14,
      latestEventSummary: 'Brayan Bello struck out Aaron Judge; Giancarlo Stanton scored on error.'
    },
  },
  ...
  // NFL GAME
  {
    ...
    scheduledTime: 'Thu, Sep 17, 2026 • 8:15 PM EDT',
    startTimeUtc: '2026-09-18T00:15:00.000Z',
    gameDate: '2026-09-17',
    displayDate: 'Thu, Sep 17, 2026',
  ...
  // CFB GAME
  {
    ...
    scheduledTime: 'FINAL • Sat, Sep 12, 2026 at 3:30 PM EDT',
    startTimeUtc: '2026-09-12T19:30:00.000Z',
    gameDate: '2026-09-12',
    displayDate: 'Sat, Sep 12, 2026',
    displayTime: '3:30 PM EDT',
    timeZone: 'EDT',
    status: 'FINAL',
  ...
  // CFB GAME 2: TEXAS vs MICHIGAN
  {
    ...
    scheduledTime: 'FINAL • Sat, Sep 12, 2026 at 12:00 PM EDT',
    startTimeUtc: '2026-09-12T16:00:00.000Z',
    gameDate: '2026-09-12',
    displayDate: 'Sat, Sep 12, 2026',
    displayTime: '12:00 PM EDT',
    timeZone: 'EDT',
    status: 'FINAL',
    ...
    actualResult: {
      ...
      f5HomeScore: 3,
      f5AwayScore: 24,
      quarterScores: 'TEX: 7-17-7-0 | MICH: 3-0-3-6',
      winner: 'TEX 31, MICH 12 (TEX Covered -7.5 by 11.5 pts)',
      brierLoss: 0.098,
      calibrationDelta: +0.006,
      enginePredictedPick: 'TEX -7.5 (-110) & Ewers Over 242.5 Pass Yds',
      enginePredictedProb: 0.684,
      enginePredictedEdge: 0.086,
      consensusLine: 'TEX -7.5 (-110) | Total 42.5',
      predictionOutcome: 'WIN',
      engineUpgradesMade: [
        'Ewers clean-pocket conversion weight verified at 0.27 EPA/pass',
        'Road favorite non-conference scoring margin multiplier reinforced in CFB Brain',
        'Big House home field advantage dampener confirmed (-1.4 pts due to offensive disruption)'
      ],
      autonomousRefactorSummary: 'Decisive road cover by Texas. SOTA EPA drive model correctly projected early Michigan offensive stall.',
      resultProvenance: {
        source: 'Official NCAA & ESPN Final Scoreboard Feed',
        verifiedAt: new Date().toISOString(),
        officialVerificationHash: 'SHA256-CFB-TEX-MICH-004-VERIFIED'
      }
    },
  },
  ...
  // MLB FINAL GAME: TEXAS RANGERS @ HOUSTON ASTROS
  {
    ...
    scheduledTime: 'FINAL • Mon, Sep 14, 2026 at 8:10 PM EDT',
    startTimeUtc: '2026-09-15T00:10:00.000Z',
    gameDate: '2026-09-14',
    displayDate: 'Mon, Sep 14, 2026',
    displayTime: '8:10 PM EDT',
    timeZone: 'EDT',
    status: 'FINAL',
  ...
  // NFL FINAL GAME: GREEN BAY PACKERS @ DETROIT LIONS
  {
    ...
    scheduledTime: 'FINAL • Sun, Sep 13, 2026 at 4:25 PM EDT',
    startTimeUtc: '2026-09-13T20:25:00.000Z',
    gameDate: '2026-09-13',
    displayDate: 'Sun, Sep 13, 2026',
    displayTime: '4:25 PM EDT',
    timeZone: 'EDT',
    status: 'FINAL',
  ...
  // NFL LIVE GAME: DALLAS COWBOYS @ PHILADELPHIA EAGLES
  {
    ...
    scheduledTime: '🔴 LIVE (Q3 8:42) • Started 8:15 PM EDT',
  ...
  // MLB UPCOMING: SAN FRANCISCO GIANTS @ LOS ANGELES DODGERS
  {
    ...
    scheduledTime: 'Tue, Sep 15, 2026 • 10:10 PM EDT',
    startTimeUtc: '2026-09-16T02:10:00.000Z',
    gameDate: '2026-09-15',
    displayDate: 'Tue, Sep 15, 2026',
    displayTime: '10:10 PM EDT',
    timeZone: 'EDT',
    status: 'UPCOMING',
  ...
  // MLB FINAL (FAILED OUTCOME & ENGINE UPGRADES): BALTIMORE ORIOLES @ NY YANKEES
  {
    id: 'mlb-bal-nyy-010',
    sport: 'MLB',
    homeTeam: {
      ...
      name: 'New York Yankees',
      record: '89-63',
      starterOrQb: 'Carlos Rodon (LHP | 3.65 xFIP, 28.5% K%)',
      rating: 93.4,
    },
    awayTeam: {
      code: 'BAL',
      ...
      record: '87-65',
      starterOrQb: 'Corbin Burnes (RHP | 3.10 xFIP, 26.2% K%)',
      rating: 92.1,
    },
    scheduledTime: 'FINAL • Sun, Sep 13, 2026 at 1:35 PM EDT',
    startTimeUtc: '2026-09-13T17:35:00.000Z',
    gameDate: '2026-09-13',
    displayDate: 'Sun, Sep 13, 2026',
    displayTime: '1:35 PM EDT',
    timeZone: 'EDT',
    status: 'FINAL',
    venue: 'Yankee Stadium, Bronx NY',
    weather: {
    ...
    weights: {
      ...
      marketOddsOptimal: 0.80,
      pitchingOrQbWeight: 1.50,
      pitchingOrQbOptimal: 1.42,
      recentFormWeight: 1.05,
      recentFormOptimal: 1.24,
      travelFatigueWeight: 0.90,
      travelFatigueOptimal: 0.90,
    },
    trueProbabilityHome: 0.674,
    consensusImpliedProbabilityHome: 0.613,
    mathematicalEdgeHome: 0.061,
    algorithmicFairMoneyline: { home: -206, away: +180 },
    algorithmicFairSpread: -1.8,
    algorithmicFairTotal: 7.9,
    marketTargets: [
      {
        market: 'MATCH_MONEYLINE',
        marketName: 'Full Game Moneyline',
        consensusLine: 'NYY -165 / BAL +140',
        consensusImpliedProb: 0.613,
        nexusCalibratedProb: 0.674,
        edgePercentage: 0.061,
        evRoiPct: 9.9,
        recommendation: 'MISS: NYY Moneyline (-165)',
        brierScoreHistorical: 0.454,
        optimalCalibrationVariance: 0.024,
      },
    ],
    playerProps: [],
    actualResult: {
      ...
      f5HomeScore: 2,
      f5AwayScore: 2,
      inningsBreakdown: 'BAL: 0-0-1 0-1-0 1-2-0 (5 R, 9 H, 0 E) | NYY: 1-0-1 0-0-0 1-0-0 (3 R, 6 H, 1 E)',
      winner: 'BAL 5, NYY 3 (BAL Won as +140 Dog)',
      brierLoss: 0.4542,
      calibrationDelta: +0.024,
      enginePredictedPick: 'NYY Moneyline (-165) & NYY F5 -0.5',
      enginePredictedProb: 0.674,
      enginePredictedEdge: 0.061,
      consensusLine: 'NYY -165 | BAL +140 | O/U 8.0',
      predictionOutcome: 'LOSS',
      engineUpgradesMade: [
        'Late-Inning Bullpen Leverage Decay factor upgraded from 1.05 to 1.38 in 7th-9th innings against top-tier bullpens',
        'Statcast xwOBA second-time-through-order decay curve recalibrated for flyball relief pitchers',
        'Bullpen walk-rate penalty coefficient increased by +22% in AL East divisional matchups',
        'Recalibrated MLB weights in Firestore: Pitching weight adjusted from 1.50 to 1.42, Recent Form raised to 1.24'
      ],
      autonomousRefactorSummary: 'PREDICTION FAILED: Model overvalued Yankees starter early dominance and under-damped bullpen leverage drop-off in innings 7-8. Autonomous refactor deployed Bullpen Leverage Decay upgrade and logged parameter update to Cloud Firestore.',
      failureAnalysis: {
        rootCause: 'Bullpen second-time-through-order decay in high leverage was severely under-damped by 0.28. Yankee bullpen surrendered 3 earned runs in innings 7-8 against Corbin Burnes and Orioles relief core who generated a 34% whiff rate.',
        primaryDeviationFactor: 'Bullpen High-Leverage ERA Divergence (Model Projected: 2.95 ERA, Realized: 6.75 ERA in innings 6-9)',
        parameterAdjustments: [
          {
            parameter: 'Bullpen High-Leverage Decay Multiplier',
            previousValue: 1.05,
            upgradedValue: 1.38,
            direction: 'INCREASED',
            rationale: 'Accounts for fatigue and pitch-arsenal familiarity when facing AL East offenses in back-to-back series games.'
          },
          {
            parameter: 'Starting Pitcher Weight (PitchingOrQbWeight)',
            previousValue: 1.50,
            upgradedValue: 1.42,
            direction: 'DECREASED',
            rationale: 'Reduces over-reliance on starter xFIP when bullpen workloads exceed 4.2 innings per game over previous 5 days.'
          },
          {
            parameter: 'Opponent Bullpen Whiff Rate Differential',
            previousValue: 0.18,
            upgradedValue: 0.29,
            direction: 'INCREASED',
            rationale: 'Penalizes high-strikeout trailing offenses against elite late-inning swing-and-miss relievers.'
          }
        ],
        safeguardEstablished: 'Bullpen Fatigue Inversion Filter: When a favored team bullpen has thrown >110 pitches over the preceding 48 hours, maximum allowable ML win probability is clamped at 62.5% regardless of starter rating.',
        persistedMemoryLocation: 'Cloud Firestore: /sport_calibrations/MLB & /learning_events/learn_mlb_nyy_bal_010'
      },
      resultProvenance: {
        source: 'Official MLB Stats API & Gameday Live Feed',
        verifiedAt: '2026-09-13T21:15:00.000Z',
        officialVerificationHash: 'SHA256-MLB-BAL-NYY-010-VERIFIED'
      }
    },
  },

  // NFL FINAL (FAILED OUTCOME & ENGINE UPGRADES): BUFFALO BILLS @ NEW YORK JETS
  {
    id: 'nfl-buf-nyj-011',
    sport: 'NFL',
    homeTeam: {
      ...
      name: 'New York Jets',
      record: '8-7',
      starterOrQb: 'Aaron Rodgers (0.16 EPA/pass, 64.8 QBR)',
      rating: 89.2,
    },
    awayTeam: {
      code: 'BUF',
      name: 'Buffalo Bills',
      record: '11-4',
      starterOrQb: 'Josh Allen (0.28 EPA/play, 78.4 QBR)',
      rating: 96.1,
    },
    scheduledTime: 'FINAL (OT) • Sun, Sep 13, 2026 at 8:20 PM EDT',
    startTimeUtc: '2026-09-14T00:20:00.000Z',
    gameDate: '2026-09-13',
    displayDate: 'Sun, Sep 13, 2026',
    displayTime: '8:20 PM EDT',
    timeZone: 'EDT',
    status: 'FINAL',
    ...
    weather: {
      ...
      humidityPct: 68,
      isDomeOrRetractableClosed: false,
      barometricPressureInHg: 29.90,
    },
    odds: {
      consensusSpread: 4.5,
      consensusMoneylineHome: +175,
      consensusMoneylineAway: -210,
      consensusTotal: 44.5,
      publicBetPctHome: 32,
      sharpMoneyPctHome: 58,
      lineMovementVelocity: +0.22,
    },
    weights: {
      weatherWeight: 1.15,
      weatherOptimal: 1.15,
      ...
      pitchingOrQbOptimal: 1.45,
      recentFormWeight: 1.10,
      recentFormOptimal: 1.22,
      travelFatigueWeight: 0.90,
      travelFatigueOptimal: 0.90,
    },
    trueProbabilityHome: 0.318,
    consensusImpliedProbabilityHome: 0.352,
    mathematicalEdgeHome: -0.034,
    algorithmicFairMoneyline: { home: +214, away: -245 },
    algorithmicFairSpread: 5.8,
    algorithmicFairTotal: 42.1,
    marketTargets: [
      {
        market: 'WINNER_SPREAD',
        marketName: 'Buffalo Bills -4.5',
        consensusLine: 'BUF -4.5 (-110)',
        consensusImpliedProb: 0.524,
        nexusCalibratedProb: 0.606,
        edgePercentage: 0.082,
        evRoiPct: 15.6,
        recommendation: 'MISS: BUF -4.5 (-110)',
        brierScoreHistorical: 0.465,
        optimalCalibrationVariance: 0.026,
      },
    ],
    playerProps: [],
    actualResult: {
      ...
      f5HomeScore: 10,
      f5AwayScore: 13,
      quarterScores: 'BUF: 3-10-3-0-0 (16) | NYJ: 3-7-3-3-6 (22 OT)',
      winner: 'NYJ 22, BUF 16 (OT) (Jets Won Outright as +175 Dog)',
      brierLoss: 0.4651,
      calibrationDelta: +0.026,
      enginePredictedPick: 'BUF -4.5 (-110) & BUF ML (-210)',
      enginePredictedProb: 0.682,
      enginePredictedEdge: 0.082,
      consensusLine: 'BUF -4.5 (-110) | O/U 44.5',
      predictionOutcome: 'LOSS',
      engineUpgradesMade: [
        'Integrated Pass Rush Pressure Index (PRPI) dampener for mobile QBs facing >35% blitz schemes',
        'Turnover margin variance elasticity increased from 1.15 to 1.46 in divisional road dog scenarios',
        'Refactored Poisson bivariate copula in Dixon-Coles model to handle overtime sudden-death rules',
        'Recalibrated NFL weights in Firestore: QB weight reduced from 1.55 to 1.45, Defensive Pressure raised to 1.30'
      ],
      autonomousRefactorSummary: 'PREDICTION FAILED: Model projected comfortable Buffalo cover (-4.5) based on QB EPA differential, failing to anticipate 4 turnovers induced by heavy blitz pressure. Upgraded blitz susceptibility metric and logged calibration changes.',
      failureAnalysis: {
        rootCause: 'Model assumed mean-reverting pass protection efficiency under aggressive zero-blitz packages (>38% blitz rate). Josh Allen committed 4 turnovers (3 INT, 1 fumble) against disguised Cover-0/Cover-1 looks.',
        primaryDeviationFactor: 'Disguised Blitz Turnover Spike (-1.24 EPA/drive when blitzed)',
        parameterAdjustments: [
          {
            parameter: 'Pass Rush Pressure Turnover Elasticity',
            previousValue: 1.15,
            upgradedValue: 1.46,
            direction: 'INCREASED',
            rationale: 'Penalizes high-variance gunslinger QBs in windy conditions against top-5 defensive pressure units.'
          },
          {
            parameter: 'Divisional Underdog Home Field Multiplier',
            previousValue: 1.85,
            upgradedValue: 2.45,
            direction: 'INCREASED',
            rationale: 'AFC East home underdogs have historically covered 63.8% in evening slot games with wind >12 mph.'
          },
          {
            parameter: 'Starting QB Isolated Weight',
            previousValue: 1.55,
            upgradedValue: 1.45,
            direction: 'DECREASED',
            rationale: 'Balances solo QB EPA with offensive tackle pass-block win rate under simulated pressure.'
          }
        ],
        safeguardEstablished: 'Divisional Blitz-Sack Disruption Ceiling: Caps road favorite spread projections at -3.0 whenever the home defense boasts a top-5 PRPI and wind exceeds 12 mph.',
        persistedMemoryLocation: 'Cloud Firestore: /sport_calibrations/NFL & /learning_events/learn_nfl_buf_nyj_011'
      },
      resultProvenance: {
        source: 'Official NFL Game Statistics & Information System (GSIS)',
        verifiedAt: '2026-09-14T03:50:00.000Z',
        officialVerificationHash: 'SHA256-NFL-BUF-NYJ-011-VERIFIED'
      }
    },
  },

  // CFB FINAL (FAILED OUTCOME & ENGINE UPGRADES): FLORIDA STATE vs GEORGIA TECH
  {
    id: 'cfb-fsu-gt-012',
    sport: 'CFB',
    homeTeam: {
      ...
      record: '10-3',
      starterOrQb: 'DJ Uiagalelei (0.19 EPA/pass, 68.4 QBR)',
      rating: 93.8,
    },
    awayTeam: {
      code: 'GT',
      ...
      record: '8-5',
      starterOrQb: 'Haynes King (Dual-Threat EPA 0.28)',
      rating: 88.2,
    },
    scheduledTime: 'FINAL • Sat, Sep 12, 2026 at 12:00 PM EDT',
    startTimeUtc: '2026-09-12T16:00:00.000Z',
    ...
    timeZone: 'EDT',
    status: 'FINAL',
    venue: 'Aviva Stadium, Dublin / Doak Campbell',
    weather: {
      temperatureF: 64,
      windSpeedMph: 8,
      windDirection: 'CALM',
      humidityPct: 56,
      isDomeOrRetractableClosed: false,
      barometricPressureInHg: 30.02,
    },
    odds: {
      consensusSpread: -10.5,
      consensusMoneylineHome: -420,
      consensusMoneylineAway: +320,
      consensusTotal: 55.5,
      publicBetPctHome: 78,
      sharpMoneyPctHome: 42,
      lineMovementVelocity: -0.28,
    },
    weights: {
      weatherWeight: 1.10,
      weatherOptimal: 1.10,
      ...
      marketOddsOptimal: 0.85,
      pitchingOrQbWeight: 1.45,
      pitchingOrQbOptimal: 1.32,
      recentFormWeight: 1.15,
      recentFormOptimal: 1.25,
      travelFatigueWeight: 1.20,
      travelFatigueOptimal: 1.35,
    },
    trueProbabilityHome: 0.765,
    consensusImpliedProbabilityHome: 0.792,
    mathematicalEdgeHome: -0.027,
    algorithmicFairMoneyline: { home: -325, away: +280 },
    algorithmicFairSpread: -8.2,
    algorithmicFairTotal: 52.8,
    marketTargets: [
      {
        market: 'WINNER_SPREAD',
        marketName: 'Point Spread FSU -10.5',
        consensusLine: 'FSU -10.5 (-110)',
        consensusImpliedProb: 0.524,
        nexusCalibratedProb: 0.598,
        edgePercentage: 0.074,
        evRoiPct: 14.1,
        recommendation: 'MISS: FSU -10.5 (-110)',
        brierScoreHistorical: 0.585,
        optimalCalibrationVariance: 0.032,
      },
    ],
    playerProps: [],
    actualResult: {
      ...
      f5HomeScore: 14,
      f5AwayScore: 14,
      quarterScores: 'FSU: 8-6-7-0 (21) | GT: 7-7-0-10 (24)',
      winner: 'GT 24, FSU 21 (Georgia Tech Outright Upset as +320 Dog)',
      brierLoss: 0.5852,
      calibrationDelta: +0.032,
      enginePredictedPick: 'FSU -10.5 (-110) & Over 55.5 Points',
      enginePredictedProb: 0.765,
      enginePredictedEdge: 0.074,
      consensusLine: 'FSU -10.5 (-110) | O/U 55.5',
      predictionOutcome: 'LOSS',
      engineUpgradesMade: [
        'Offensive Line Returning Starts & Continuity metric weight increased from 0.85 to 1.42',
        'Transfer Portal Talent composite weighting reduced by -35% in early season games',
        'Established Rushing Success Rate vs Explosive Play dampener in Markov drive simulator',
        'CFB weights updated and permanently stored in Cloud Firestore memory'
      ],
      autonomousRefactorSummary: 'PREDICTION FAILED: Model overvalued FSU transfer portal roster talent and failed to account for offensive line cohesion. Georgia Tech dominated time of possession (36:24) with 64% rushing success rate. Autonomous engine upgraded offensive line continuity factor.',
      failureAnalysis: {
        rootCause: 'Model over-weighted transfer portal composite talent ratings (+0.35) while severely under-weighting offensive line returning starts and continuity. Georgia Tech offensive line controlled the line of scrimmage with 64% rushing success rate.',
        primaryDeviationFactor: 'Offensive Line Returning Starts Cohesion Deficit (GT: 84 combined starts vs FSU: 21 combined starts)',
        parameterAdjustments: [
          {
            parameter: 'Offensive Line Continuity & Returning Starts Weight',
            previousValue: 0.85,
            upgradedValue: 1.42,
            direction: 'INCREASED',
            rationale: 'Cohesion and unit chemistry in the trenches outweighs individual recruit star rankings in weeks 1-4.'
          },
          {
            parameter: 'Transfer Portal Talent Composite Elasticity',
            previousValue: 1.35,
            upgradedValue: 0.88,
            direction: 'DECREASED',
            rationale: 'Reduces overconfidence in unproven plug-and-play portal rosters facing established scheme continuity.'
          },
          {
            parameter: 'Option / QB-Run Scheme Defensive Vulnerability',
            previousValue: 1.00,
            upgradedValue: 1.28,
            direction: 'INCREASED',
            rationale: 'Accounts for defensive discipline breakdown against disciplined option-read attacks.'
          }
        ],
        safeguardEstablished: 'Trench Cohesion Minimum Threshold: Teams with fewer than 40 returning offensive line starts are automatically capped at a maximum of -7.0 point spread against veteran defensive fronts.',
        persistedMemoryLocation: 'Cloud Firestore: /sport_calibrations/CFB & /learning_events/learn_cfb_fsu_gt_012'
      },
      resultProvenance: {
        source: 'Official NCAA College Football Scoreboard & Play-by-Play Records',
        verifiedAt: '2026-09-12T19:45:00.000Z',
        officialVerificationHash: 'SHA256-CFB-FSU-GT-012-VERIFIED'
      }
    },
  },
];
